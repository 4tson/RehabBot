...
public class DBQueriesConstants {
	...
	public static final String SELECT_SERVICES_BY_DISCID = "SELECT S.SERVICEID, S.FARMS + 'F/' + S.RATEMINUTES + 'Mins For ' + S.LENGTHHOURS + 'Hrs.', S.PRICE, D.NAME, S.FORSALE, 73, CASE WHEN S.ACTIVE THEN 'Y' ELSE 'N' END, S.FARMS + 'F/' + S.RATEMINUTES + 'M\n' + S.LENGTHHOURS + 'H' FROM SERVICES S, DEGENS D WHERE S.DEGENID = D.DEGENID AND D.DISCORDID = ?";
