...
public class DBQueriesConstants {
	...
	public static final String INSERT_NEW_DEGEN = "INSERT INTO DEGENS (DISCORDID,NAME,IRONMAN) VALUES (?,?,?) as new on duplicate key update active = true";
	...
	public static final String SELECT_PRED_SERVICES = "SELECT S.SERVICEID, concat(S.FARMS ,'F/' ,S.RATEMINUTES ,'Mins For ',S.LENGTHHOURS, 'Hrs.'), S.PRICE, D.NAME, S.FORSALE, S.PRICE, CASE WHEN S.ACTIVE THEN 'Y' ELSE 'N' END FROM SERVICES S, DEGENS D WHERE S.DEGENID = D.DEGENID AND S.PREDETERMINED IS TRUE AND S.ACTIVE IS FALSE";
	...
	public static final String INSERT_PREDETERMINED_SERVICE = "INSERT INTO SERVICES(FARMS, LENGTHHOURS, NAME, RATEMINUTES, DEGENID,PREDETERMINED, PRICE) VALUES (?,?,?,?,?,?,?)";
