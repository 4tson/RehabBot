...
public class DBQueriesConstants {
	...
	public static final String SELECT_SERVICES_BY_DISCID = "SELECT S.SERVICEID, concat(S.FARMS ,'F/' ,S.RATEMINUTES ,'Mins For ',S.LENGTHHOURS, 'Hrs.'), S.PRICE, D.NAME, S.FORSALE, 73, CASE WHEN S.ACTIVE THEN 'Y' ELSE 'N' END, S.FARMS + 'F/' + S.RATEMINUTES + 'M\n' + S.LENGTHHOURS + 'H' FROM SERVICES S, DEGENS D WHERE S.DEGENID = D.DEGENID AND D.DISCORDID = ?";
	...
	public static final String SELECT_PRED_SERVICES = "SELECT S.SERVICEID, concat(S.FARMS ,'F/' ,S.RATEMINUTES ,'Mins For ',S.LENGTHHOURS, 'Hrs.'), S.PRICE, D.NAME, S.FORSALE, S.PRICE, CASE WHEN S.ACTIVE THEN 'Y' ELSE 'N' END FROM SERVICES S, DEGENS D WHERE S.DEGENID = D.DEGENID AND S.PREDETERMINED IS TRUE AND ACTIVE IS FALSE";
	...
	public static final String SELECT_BIDDABLE_SERVICE = "SELECT S.SERVICEID, S.FARMS, S.LENGTHHOURS, S.NAME, S.RATEMINUTES, S.FORSALE, S.ACTIVE, S.DEGENID, D.DISCORDID, S.PRICE, D.NAME FROM SERVICES S, DEGENS D WHERE D.DEGENID = S.DEGENID AND S.BIDDABLE = TRUE AND S.ACTIVE = TRUE";
	
	public static final String GET_BIDDABLE_SERVICE_ID = "SELECT SERVICEID FROM SERVICES WHERE BIDDABLE = TRUE";
	
	public static final String UPDATE_BIDDABLE_SERVICE = "UPDATE SERVICES SET FARMS = ?, LENGTHHOURS = ?, NAME = ?, RATEMINUTES = ?, DEGENID = ?, ACTIVE = TRUE WHERE BIDDABLE = TRUE";
	...
	public static final String INSERT_PREDETERMINED_SERVICE = "INSERT INTO SERVICES(FARMS, LENGTHHOURS, NAME, RATEMINUTES, DEGENID) VALUES (?,?,?,?,?)";
